...
export type DirectionType =
  ...
  | typeof wsw
  | typeof weast;
export const directionArray: DirectionType[] = [
  north,
  nne,
  ne,
  ene,
...
export const gradeArray: PmType[] = ["좋음", "보통", "나쁨", "매우 나쁨"];
...
export const areaArray: AreaInform[] = [
  {
    name: 서울,
    sfGrid: {
      areaCode: "1100000000",
...
export const getWsd = (wsd: string, vec: number): DirectionType => {
  ...
  const direction = directionArray[cv];
